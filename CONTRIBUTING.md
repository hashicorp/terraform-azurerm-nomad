...
functionality you're adding in your contribution. Check out the [tests](https://github.com/hashicorp/terraform-azurerm-nomad/tree/master/tests) folder for instructions on running the 
automated tests. 
